...
## ✅ Liste de vérification de soumission

Avant de soumettre sur GitHub et Google Form :

- [ ] **Notebook s'exécute sans erreurs** : `jupyter nbconvert --to notebook --inplace --execute`
- [ ] **Toutes les sorties générées** : `ls -la outputs/` affiche 8+ fichiers CSV/Parquet
- [ ] **Métriques enregistrées** : `cat proof/lab_metrics_log.csv` affiche les runs 3–8
- [ ] **Plans EXPLAIN sauvegardés** : `proof/explain_*.txt` existent
- [ ] **ENV.md à jour** : Versions, configurations, recommandations
- [ ] **README.md complet** : Ce fichier avec toutes les sections
- [ ] **Chemins relatifs uniquement** : Pas de chemins absolus dans le code
- [ ] **Screenshots attachés** : Preuves Spark UI (optionnel mais recommandé)
- [ ] **genai.md si applicable** : Déclarer toute assistance IA utilisée
...
## 📞 Support et heures de bureau

**Instructeur** : Badr TAJINI  
**Cours** : Big Data Analytics — ESIEE 2025-2026  
**Email** : badr.tajini@esiee.fr (voir la page du cours pour les heures de bureau)

---

**Dernière mise à jour** : 2025-11-20  
**État** : ✅ Complète (Parties A–D)  
**Suivant** : Assignment 03 — Analytics sur graphes (PageRank, PPR)
